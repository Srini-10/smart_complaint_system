...
export default function RegisterPage() {
    const { register: registerUser, loginWithGoogle, error: authError, user, isLoading: authLoading } = useAuth(); // Add user and isLoading
    ...
    const handleGoogleLogin = async () => {
        ...
        // No finally block for success case because we redirect
    };
                ...
                <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 p-8">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full py-2.5 px-4 gradient-primary text-white font-semibold rounded-lg hover:opacity-90 disabled:opacity-60 transition flex items-center justify-center gap-2"
                        >
                    ...
                    <button
                        ...
                        className="w-full py-2.5 px-4 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-60 transition flex items-center justify-center gap-3"
                    >
